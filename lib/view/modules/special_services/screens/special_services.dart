...
class SpecialServices extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(create: (context) => SpecialServicesCubit()),
        BlocProvider(create: (context) => CarServiceCubit()),
        BlocProvider(create: (context) => GuideServiceCubit()),
        BlocProvider(create: (context) => PackageServiceCubit()),
      ],
      child: Builder(
        builder: (context) {
                            ...
                            child: Padding(
                              ...
                              child: TabBarView(
                                ...
                                children: [
                                  ...
                                  TourGuidePage(controller: guideController),
                                  CustomProgramPage(
