            ...
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                TripModel tripModel = TripModel.fromJson(
                  homePageController.vipData[index],
                );
                bool isFavorite = context.watch<FavoriteCubit>().isTripFavorite(
                  tripModel.id.toString(),
                );
                return InkWell(
                  onTap: () {
                    homePageController.goToProgramDetails2(tripModel.id);
                  },
                  child: Container(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              image: DecorationImage(
                                image: AssetImage(AppImages().crown),
                              ),
                            ),
                          ),
                        ),
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                      onTap: () {
                                        homePageController.goToProgramDetails2(
                                          tripModel.id,
                                        );
                                      },
                                      child: Container(
