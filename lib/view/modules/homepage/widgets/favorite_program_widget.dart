...
import 'package:jawla/model/favorite/favorite_model.dart';
...
class FavoriteProgramWidget extends StatelessWidget {
  ...
  const FavoriteProgramWidget({super.key, required this.favoriteController});
          ...
          return SizedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                FavoriteModel favoriteModel = FavoriteModel.fromJson(
                  favoriteController.data[index],
                );
                return InkWell(
                  onTap: () {
                    favoriteController.goToProgramDetails(favoriteModel.id);
                  },
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image:
                            favoriteModel.mainImage == null ||
                                    favoriteModel.mainImage == ""
                                ? AssetImage(AppImages().bj2) as ImageProvider
                      ...
                      children: [
                        Positioned(
                          ...
                          child: CircleAvatar(
                            ...
                            child: IconButton(
                              onPressed: () {
                                favoriteController.removeFavoriteFun(
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      InkWell(
                                        onTap: () {
                                          favoriteController.goToProgramDetails(
                                            favoriteModel.id,
                                          );
                                        },
                                        child: Container(
